...
class RouterosAPI
{
	...
	/// To active a user
	public function userActive($RouterIpAddress,$RouterUserName,$RouterPassWord,$EnableUserName){
		
		// Connetion exp manage
		
			$Connects = $this->connect($RouterIpAddress, $RouterUserName, $RouterPassWord);
			if ($Connects)
			{
				$this->comm('/ppp/secret/enable ',array(
				"numbers" => "". $EnableUserName .""
				));
	...
	// To deactive a user
	public function userDeactive($RouterIpAddress,$RouterUserName,$RouterPassWord,$DeactiveUserName){
		...
		// Connetion exp manage
			...
			if ($Connects)
			{
				$this->comm('/interface/pppoe-server/remove ',array(
				"numbers" => "<pppoe-". $DeactiveUserName .">"
				));
				$this->comm('/ppp/secret/disable ',array(
				"numbers" => "". $DeactiveUserName .""
				));
				$this->disconnect();
			}
	}
